...
const rayonBalle = 10, barreHeight = 10,  barreWidth = 75, nbCol = 8,
 nbRow = 5, largeurBrique = 75, hauteurBrique = 20;

let x = canvas.width/2, y = canvas.height -30,
barreX = (canvas.width - barreWidth)/2, fin = false, vitesseX = 5, vitesseY = -5;
            ...
            if(b.statut === 1){
                ...
                if(x > b.x && x < b.x + largeurBrique && y > b.y && y < b.y + hauteurBrique){
                    ...
                    if(score === nbCol * nbRow){
                        affichageScore.innerHTML = `Bravo! Partie fantistique belle performance <br> Clique sur le casse-Brique pour recommencer.`
                        fin = true;
                    }
...
function mouvementSouris(e){
    ...
    //e.clienX = de la gauche juasqu'a la souris
    //canvas.offestLeft = decalage  par rapport a la gauche
